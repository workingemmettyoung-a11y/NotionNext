...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Emmett', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '理想主义者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://work2death.icu', // 网站地址
